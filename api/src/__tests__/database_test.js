...
test(
    'Society should not be able to have two link records',
    async () => {
        await expect(
...
test(
    'A user should not be in a committee twice',
    async () => {
        await expect(
...
test(
    'A user should not be a member of a society twice',
    async () => {
        await expect(
...
test(
    'A ticket should not have two records with the same userId and eventId',
    async () => {
        await expect(
...
test(
    'A user should not be able to purchase the same ticket twice',
    async () => {
        await expect(
            prisma.ticket.create({
                data: {
