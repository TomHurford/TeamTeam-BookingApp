...
beforeAll(async () => {
    console.log('MAKE SURE THAT BEFORE YOU RUN THESE TESTS YOU HAVE RUN: npx prisma migrate reset');
});
...
describe('Update society', () => {
    ...
    test('Update society as a user with no permission', async () => {
        ...
        expect(res2.body.message).toBe('You do not have permission to perform this action');
    });
});
