...
const EditSocietyCommittee = (props) => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.post(
          "https://localhost:5001/societies/getCommitteeMembers",
          {
  ...
  const handleRemoveMember = async (userId) => {
    ...
    await fetch("https://localhost:5001/societies/removeCommitteeMember", {
      method: "POST",
      mode: "cors",
      headers: {
  ...
  const handleAddMember = async (email) => {
    ...
    await fetch("https://localhost:5001/societies/addCommitteeMember", {
      method: "POST",
      mode: "cors",
      headers: {
        "Content-Type": "application/json",
